...
class _PindahPageState extends State<PindahPage> {
  ...
  void addData(data) async {
    ...
    if (state is UserSuccess) {
      ...
      showAlert("success", "Pindah Transaksi Berhasil");
  ...
  void submit() {
    if (currentOutletId == "") {
      showAlert("danger", "Pilih Nama Outlet Dari Mana Terlebih Dahulu");
    } else if (currentOutletId2 == "") {
      showAlert("danger", "Pilih Nama Outlet Ke Mana Terlebih Dahulu");
